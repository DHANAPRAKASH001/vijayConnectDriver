...
const LocalTripDashboard = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.localTripContainer}>
        <Text style={styles.localTripText}>Local Trip</Text>
      </View>
          ...
          <View style={styles.bookingRequestModalContainer}>
            ...
            <View style={styles.bookingInfoContainer}>
              ...
              <View style={styles.bookingInfoRow}>
                ...
                <Text style={styles.bookingInfoText1}>Local Trip</Text>
              </View>
            ...
            <View style={styles.confirmationButtonContainer}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  navigation.navigate('LocalTripCompletedScreen'); // Navigate to Trip Completed Screen
                }}
              >
...
const styles = StyleSheet.create({
  ...
  reachButton: {
    ...
    // backgroundColor: '#990011', //changed colour 
    // backgroundColor: '#990F1F',
    padding: 15,
    borderRadius: 10,
    width: '80%',
    alignItems: 'center',
...
export default LocalTripDashboard;