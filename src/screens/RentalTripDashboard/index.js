...
const RentalTripDashboard = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.localTripContainer}>
        <Text style={styles.localTripText}>Rental Trip</Text>
      </View>
          ...
          <View style={styles.bookingRequestModalContainer}>
            ...
            <View style={styles.bookingInfoContainer}>
              ...
              <View style={styles.bookingInfoRow}>
                ...
                <Text style={styles.bookingInfoText1}>Rental Trip</Text>
              </View>
            ...
            <View style={styles.confirmationButtonContainer}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  navigation.navigate('RentalTripCompletedDetails'); // Navigate to Trip Completed Screen
                }}
              >
...
export default RentalTripDashboard;